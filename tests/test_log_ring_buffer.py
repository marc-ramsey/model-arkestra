"""Tests for _Model ring buffer — direct, no mocks."""
import sys
...
class TestContextLogBuffer:
    ...
    def test_buffer_overflow_discards_oldest(self):
        ...
        ctx = _Model("test", 2000, max_log_lines=2)
